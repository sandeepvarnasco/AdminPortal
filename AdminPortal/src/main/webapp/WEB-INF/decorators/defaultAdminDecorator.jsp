...
<title><sitemesh:write property='title'/></title>
  ...
  <link href="${contextPath}/resources/css/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${contextPath}/resources/img/avatar3.png" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${contextPath}/resources/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
...
<sitemesh:write property='footer'/>
	 ...
	 <script src="${contextPath}/resources/js/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript"></script>
